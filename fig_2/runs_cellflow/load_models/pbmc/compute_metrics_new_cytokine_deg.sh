...
mapfile -t list_preds < <(jq -r '.[]' /lustre/groups/ml01/workspace/ot_perturbation/models/cellflow/pbmc_new_cytokine_new/file_names.json)
...
python compute_metrics_new_cytokine_deg.py "${split}"
EOF
done
