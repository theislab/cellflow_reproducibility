...
if __name__ == "__main__":
    out_dir_mean_model_1 = "/lustre/groups/ml01/workspace/ot_perturbation/models/additive_model/pbmc_new_cytokine/mean_model_same_donor_deg"
    cytokine_held_out = sys.argv[1]
    idx_given_cytokine = sys.argv[2]
    ...
    with open("/lustre/groups/ml01/workspace/ot_perturbation/data/pbmc/degs_no_threshold.pkl", "rb") as pickle_file:
    ...
    for donor in donors_to_impute:
        ...
        pred1 = mean_model_1(adata_train, adata_ctrl_current_donor, donor)
        ...
        pd.DataFrame.from_dict(out, columns=[condition], orient="index").to_csv(os.path.join(out_dir_mean_model_1, f"{idx_given_cytokine}_{condition}.csv"))
