...
if __name__ == "__main__":
    ...
    esm2_embeddings = adata_base.uns["esm2_embeddings"]
    ...
    for donor in donors_to_impute:
        ...
        train_embeddings = get_train_embeddings(adata_train[adata_train.obs["donor"]==donor], esm2_embeddings)
        closest_embedding = find_closest_embedding(esm2_embeddings[cytokine_held_out], train_embeddings)
        ...
        print("saved results for", condition)
