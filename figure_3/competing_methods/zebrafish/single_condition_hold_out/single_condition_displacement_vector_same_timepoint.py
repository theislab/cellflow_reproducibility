...
if __name__ == "__main__":
    ...
    out_dir = "/lustre/groups/ml01/workspace/ot_perturbation/models/identity/zebrafish/single_condition_displacement_vector_same_timepoint"
    ...
    for ood_cond in ood_conds:
        ...
        pd.DataFrame.from_dict(ood_cond_results[ood_cond], columns=[ood_cond], orient="index").to_csv(os.path.join(out_dir, f"{ood_cond}_displacement_same_timepoint.csv"))
