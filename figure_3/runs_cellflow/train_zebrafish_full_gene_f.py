...
def run(config):
    ...
    adata_train = adata[adata.obs["gene_target"]!=ood_cond]
    ...
    wandb_callback = cfp.training.WandbLogger(project="cfp_otfm_zebrafish_full_gene_f", out_dir="/home/icb/dominik.klein/tmp", config=config_dict)
    ...
    out_dir = "/lustre/groups/ml01/workspace/ot_perturbation/models/otfm/zebrafish/full_gene_f"
