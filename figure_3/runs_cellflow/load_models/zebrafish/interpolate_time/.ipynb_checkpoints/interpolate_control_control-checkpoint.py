...
covariate_data = adata[adata.obs["condition"]=="control_control_24"].obs.drop_duplicates(subset=["condition"])
...
adata_ood_result.write_h5ad(os.path.join(output_dir, "interpolated_control_control_no_annotation.h5ad"))
...
adata_ood_result.write_h5ad(os.path.join(output_dir, "interpolated_control_control_with_annotation.h5ad"))

adata_ood_result.obs.to_csv(os.path.join(output_dir, "interpolated_control_control_obs.csv"))
