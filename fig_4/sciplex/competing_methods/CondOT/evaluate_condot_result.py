...
cfpp.project_pca(query_adata=adata_pred_test, ref_adata=adata_ref, layer="X_recon_pred")
...
cfpp.project_pca(query_adata=adata_pred_ood, ref_adata=adata_ref, layer="X_recon_pred")
...
if split == "5":
    ...
    pd.DataFrame.from_dict(deg_test_metrics).to_csv(os.path.join(output_dir, f"test_metrics_ood_{split}.csv"))
