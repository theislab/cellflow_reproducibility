...
d["25"] = {}
d["25"]["cytokines_to_train_data"] = ["PBS"]
d["25"]['cytokines_to_impute'] = cytokines_to_impute

adata_to_append = adata_rest[adata_rest.obs["cytokine"]=="PBS"]
...
os.makedirs(f"/lustre/groups/ml01/workspace/ot_perturbation/data/pbmc/new_donor/{ood_donor}/{str(25)}", exist_ok=True)
adata_train.write(f"/lustre/groups/ml01/workspace/ot_perturbation/data/pbmc/new_donor/{ood_donor}/{str(25)}/adata_train_{ood_donor}.h5ad")
adata_ood_perturbed.write(f"/lustre/groups/ml01/workspace/ot_perturbation/data/pbmc/new_donor/{ood_donor}/{str(25)}/adata_ood_{ood_donor}.h5ad")
