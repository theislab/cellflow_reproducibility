...
from cfp.preprocessing import transfer_labels, compute_wknn, project_pca
from cfp.training import ComputationCallback
...
if __name__ == "__main__":
    ...
    for donor in donors_to_impute:
        ...
        pred1 = mean_model_2(adata_train, adata_ctrl_current_donor, cytokine_held_out)
        ...
        pd.DataFrame.from_dict(out, columns=[condition], orient="index").to_csv(os.path.join(out_dir_mean_model_2, f"{idx_given_cytokine}_{condition}.csv"))
