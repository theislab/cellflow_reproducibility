...
if __name__ == "__main__":
    out_dir_mean_model_1 = "/lustre/groups/ml01/workspace/ot_perturbation/models/additive_model/pbmc_new_donor/mean_model_same_donor"
    ...
    for cytokine in cytokines_to_impute:
        pred1 = mean_model_1(adata_train, adata_ctrl_current_donor, donor_held_out)
        ...
        pd.DataFrame.from_dict(out, columns=[condition], orient="index").to_csv(os.path.join(out_dir_mean_model_1, f"{idx_given_donor}_{condition}.csv"))
