...
for tuple in "${tuples[@]}"; do
    ...
    sbatch <<EOF
#!/bin/bash
#SBATCH -o eval_condot_sciplex_"$split".out
#SBATCH -e eval_condot_sciplex_"$split".err
#SBATCH -J eval_condot_sciplex_"$split"
#SBATCH -p gpu_p
#SBATCH --qos=gpu_max
#SBATCH --gres=gpu:1
#SBATCH --mem=120G
...
python evaluate_condot_result.py "$split" 
EOF
done
