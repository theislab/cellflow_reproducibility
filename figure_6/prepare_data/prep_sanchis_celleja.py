...
QUERY_PATH = "/home/fleckj/projects/juniper/data/datasets/FatimaPatterningScreen/240710_fatima_patscreen_v1_common_hv2k_wknn.h5ad"
MODEL_DIR = "/home/fleckj/projects/atlas/data/results/atlasv3_scanvi_scarches/v7/subregion_class/query_scarches_nolabs"

RESULTS_DIR = "/home/fleckj/projects/cellflow/results/fatima_braun_mapping/"

PLOT_DIR = "/home/fleckj/projects/cellflow/plots/fatima_braun_mapping/"
...
adata_q.obs["batch"] = "SanchisCalleja2024"
...
adata_q.write(
    f"/projects/site/pred/organoid-atlas/data/local/perturbation/PatterningScreenFatima/fatima_patscreen_v1_common_hv2k_wknn.h5ad"
)

os.makedirs(f"{RESULTS_DIR}/fatima_braun_scanvi", exist_ok=True)
mapper.save(f"{RESULTS_DIR}/fatima_braun_scanvi/mapper.pkl")


mapper = AtlasMapper.load(f"{RESULTS_DIR}/fatima_braun_scanvi/")
...
plt.savefig(f"{PLOT_DIR}/fatima_braun_scanvi_umap_label_transfer.png")
...
plt.savefig(f"{PLOT_DIR}/fatima_braun_scanvi_umap_leiden50.png")
...
for dims in dims_to_plot:
    ...
    plt.savefig(
        f"{PLOT_DIR}/scanvi_latent/fatima_braun_scanvi_umap_region_dims_{dims[0]}_{dims[1]}.png"
    )
