...
for tuple in "${tuples[@]}"; do
    ...
    sbatch <<EOF
#!/bin/bash
#SBATCH -o eval_recon_sciplex_"$split".out
#SBATCH -e eval_recon_sciplex_"$split".err
#SBATCH -J eval_recon_sciplex_"$split"
#SBATCH -p gpu_p
#SBATCH --qos=gpu_max
#SBATCH --gres=gpu:1
#SBATCH --mem=140G
...
python evaluate_reconstruction_error.py "$split" 
EOF
done
