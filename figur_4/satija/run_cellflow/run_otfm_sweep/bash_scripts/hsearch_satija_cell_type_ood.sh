...
python /home/icb/alessandro.palma/environment/ot_pert/ot_pert_reproducibility/run_otfm_sweep/train_satija_gene_ood.py --m 
dataset=satija_cell_type_ood_split_BXPC3 logger=satija_cell_type_ood_BXCP3 training=satija_ifng launcher=slurm_icb model=satija_leaveout hparams_search=satija_ifng 
