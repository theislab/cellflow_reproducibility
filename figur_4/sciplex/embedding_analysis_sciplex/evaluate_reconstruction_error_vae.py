...
adata_pred_test.obsm["X_scVI"] = vae.get_latent_representation(adata_pred_test)
adata_pred_ood.obsm["X_scVI"] = vae.get_latent_representation(adata_pred_ood)

adata_pred_test.X = np.array(vae.get_reconstructed_expression(adata_pred_test))
adata_pred_ood.X = np.array(vae.get_reconstructed_expression(adata_pred_ood))
...
pd.DataFrame.from_dict(ood_metrics_encoded).to_csv(os.path.join(output_dir, f"ood_metrics_encoded_vae.csv"))
pd.DataFrame.from_dict(ood_metrics_decoded).to_csv(os.path.join(output_dir, f"ood_metrics_decoded_vae.csv"))
pd.DataFrame.from_dict(deg_ood_metrics).to_csv(os.path.join(output_dir, f"ood_metrics_ood_vae.csv"))
...
pd.DataFrame.from_dict(test_metrics_encoded).to_csv(os.path.join(output_dir, f"test_metrics_encoded_vae.csv"))
pd.DataFrame.from_dict(test_metrics_decoded).to_csv(os.path.join(output_dir, f"test_metrics_decoded_vae.csv"))
pd.DataFrame.from_dict(deg_test_metrics).to_csv(os.path.join(output_dir, f"test_metrics_deg_vae.csv"))
